...
class Obstacales(pygame.sprite.Sprite):
...
pygame.display.set_caption('Mr.Pixel')
...
# fly
fly_farme_1 = pygame.image.load('fly/fly1.png').convert_alpha()
fly_farme_2 = pygame.image.load('fly/fly2.png').convert_alpha()
fly_frames = [fly_farme_1,fly_farme_2]
fly_frame_index=0
...
player_rec = player_surf.get_rect(topleft=(50,216))
player_gravity=0
...
while True:
    for event in pygame.event.get():
        ...
        if game_active:
            if event.type ==obstacle_timer:
                obstacle_group.add(Obstacales(choice(['fly','snail','snail','snail'])))
    ...
    if game_active:
        ...
        player_rec.midbottom=(50,216)
        player_gravity=0

        score_message = test_font.render(f'Mr.Pixel only lived for: {score} Second',False,(111,196,169))
